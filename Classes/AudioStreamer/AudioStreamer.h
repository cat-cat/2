...
#define kNumAQBufs 4//16			// Number of audio queue buffers we allocate.
...
#define kAQDefaultBufSize 16384	// Number of bytes in each audio queue buffer
...
@property (assign) BOOL needDecode;
